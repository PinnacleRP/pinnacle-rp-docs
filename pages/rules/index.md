...
For in-game rule breaks against a player, please use `/report` in city or open a ticket in Discord. Be specific and descriptive in your reports. Vague requests like "admin to me" or "my car is broken" will not receive a response.
...
When reporting in a ticket, you must provide a clip that has 1 minute prior and after the indcident.
...
- Police Roleplayer of the Month
...
You are allowed to take a cop hostage and request for your friend to get released from police custody ONLY when they are at MRPD. If they are sent off, you can't do anything. Taking anyone that isn't a cop hostage, you can NOT request to have someone freed. 1 person released = 1 demand.
